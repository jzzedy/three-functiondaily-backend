...
if (JWT_SECRET_KEY === 'your-fallback-secret-key-is-very-important-and-should-be-long' && process.env.NODE_ENV !== 'test') {
    console.warn('WARNING: JWT_SECRET is using a fallback value. Please set a strong secret in your .env file for production.');
}
